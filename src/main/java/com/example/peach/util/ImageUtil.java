...
public class ImageUtil {
    ...
    public Image toImage(String path) throws Exception {
    ...
    public void responseImg(HttpServletResponse response ,String imgPath) {
        ...
        try {
            ...
            if(file.exists()) {
                ...
                new RuntimeException("图片不存在");
            }
        } catch (Exception e) {
            new RuntimeException("写出图片失败");
        }
    }
     ...
     */
    public static void markImgeByText(String logoText, String srcImgPath,String newImagePath,Integer degree,Color color,String formaName){
        InputStream is = null;
        ...
        try {
            ...
            g.drawString(logoText, (float) (buffImg.getWidth()/7), (float) (buffImg.getHeight()/1.5));
            // 9、释放资源
            g.dispose();
            // 10、生成图片
